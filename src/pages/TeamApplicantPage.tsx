    ...
    <>
      <div className="flex flex-col items-center gap-[6rem] pt-[5.4rem]">
        ...
        <div className="flex w-full max-w-[clamp(98.2rem,70vw,130rem)] justify-between gap-[clamp(5rem,calc(-7.3rem+6.875vw),6.2rem)]">
          {/* 프로젝트 목록 */}
          <div className="max-h-[40.7rem] min-h-[16.1rem] w-full min-w-[25.6rem] max-w-[36.3rem] rounded-[0.8rem] border border-black-20 p-[1rem]">
            <div
              onClick={() => {
          ...
          {/* 지원자 목록 */}
          <div className="flex aspect-[676/544] w-full min-w-[67.6rem] max-w-[87.5rem] flex-col overflow-y-scroll rounded-[0.8rem] py-[1rem] shadow-applicants-card scrollbar-hide">
            {!applicantData ||
                        ...
                        <div className="flex items-center gap-[4.2rem]">
                          ...
                          <div className="flex items-center gap-[2.4rem]">
                            ...
                            <ChevronDownIcon
                              onClick={() => {
                                const isOpening =
                                  expandedAppId !== applicant.applicationId;
