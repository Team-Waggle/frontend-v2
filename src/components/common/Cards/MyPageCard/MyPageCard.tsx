...
const MyPageCard = ({
  ...
  return (
    <article
      className={`flex w-full cursor-pointer items-start gap-[1.6rem] rounded-[1.6rem] border border-solid border-black-30 bg-black-5 p-[1.6rem] sm:p-[2.4rem] lg:max-w-[49.4rem] ${isVisible === false ? 'opacity-60' : ''}`}
